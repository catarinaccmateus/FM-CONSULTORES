...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../../scripts/content.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.pt = exports.en = void 0;
var en = {
  navAbout: 'About',
  ...
  aboutAbout: "About us",
  aboutDescription: "'FM Consultores Associados' was formed on May 25, 1990. <br> Its founder, Fernando Mateus, has a degree in Organization and Business Management, and he is registered in the Order of Certified Accountants since August 4, 1987 under number 23776. He is a member of the Governing Bodies of several private companies, he started his professional activity leading the Accounting Services of the Portuguese Industrial Association.",
...
var pt = {
  ...
  clientsDescription: 'Desde da sua fundação veio sempre a crescer e conta com uma grande carteira de clientes de diferentes setores.',
...
function englishWebsite() {
  var enKeys = Object.keys(_content.en);

  for (var _i = 0, _enKeys = enKeys; _i < _enKeys.length; _i++) {
    var key = _enKeys[_i];
    document.getElementById(key).innerHTML = _content.en[key];
  }
}
...
function portuguesehWebsite() {
  var ptKeys = Object.keys(_content.pt);

  for (var _i2 = 0, _ptKeys = ptKeys; _i2 < _ptKeys.length; _i2++) {
    var key = _ptKeys[_i2];
    document.getElementById(key).innerHTML = _content.pt[key];
  }
}

;
},{"./content":"../../scripts/content.js"}],"../../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
