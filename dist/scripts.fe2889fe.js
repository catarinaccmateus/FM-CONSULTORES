...
},{"./..\\images\\entrada-alargada.jpg":[["entrada-alargada.a9ebf62f.jpg","../../images/entrada-alargada.jpg"],"../../images/entrada-alargada.jpg"],"_css_loader":"../../../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../../scripts/index.js":[function(require,module,exports) {
"use strict";
...
var slideIndex = 0;
var clientsCarousel = setInterval(showSlides, 1500);
...
var imageServices = document.getElementsByClassName('individual-service');
var observer = new IntersectionObserver(function (entries) {
  if (entries[0].isIntersecting === true) {
    console.log('Element has just become visible in screen');

    for (var _i2 = 0; _i2 < imageServices.length; _i2++) {
      imageServices[_i2].classList.add('is-visible');
    }
  }
}, {
  threshold: [0]
});
observer.observe(document.querySelector(".individual-service")); // PREVIOUS ATTEMPTS
// 1.
...
//# sourceMappingURL=/scripts.fe2889fe.js.map